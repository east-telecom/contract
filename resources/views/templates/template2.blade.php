...
@section('content')
    ...
    <section class="app-user-list js_data_all">
        ...
        <div class="card contract-text">
            <h4 class="text-center mt-1"> ДОГОВОР ПОДРЯДА № <span class="text_edit js_number" contenteditable="false">900-1195</span></h4>
            ...
            <div>
                ...
                <p class="text-center text-bold mb-0 mt-1">2. ОБЯЗАННОСТИ СТОРОН</p>
                ...
                <p class="text-center text-bold mb-0">З. ПОРЯДОК ПРИЕМКИ И СДАЧИ РАБОТ</p>
                3.1. Прием-передача выполненных работ производится по Акту выполненных работ.
                ...
                <p class="text-center text-bold mb-0">4. ЦЕНА ДОГОВОРА</p>
                ...
                <span class="text_edit" contenteditable="false"><b>14 000 000,00</b></span> <span class="text_edit" contenteditable="false">сум</span>
                (<span class="text-info">четырнадцать миллионов</span>) <span class="text_edit" contenteditable="false">с учётом НДС.</span> <br>
                ...
                <p class="text-center text-bold mb-0">6. ОТВЕТСТВЕННОСТЬ СТОРОН</p>
        ...
        <div class="card contract-text">
            ...
            <p class="text-center text-bold mb-0">7. ФОРС-МАЖОР</p>
            ...
            7.2. Обстоятельства «форс-мажора» включают, но не ограничиваются нижеследующими: стихийные бедствия (землетрясение, наводнение, пожары и др.),
            гражданские волнения или массовые общественные беспорядки, военный переворот, военные конфликты или военные действия, забастовки и иные трудовые конфликты,
            законы, постановления и распоряжения государственных органов в соответствующих субъектах, ограничивающие и/или делающие невозможным исполнение настоящего договора,
            а также по причинам задержки получения технических условий и разрешительных документов на подготовку проектно-сметной документации и выполнение работ. <br>
            ...
            <p class="text-center text-bold mb-0">8. РАССМОТРЕНИЕ СПОРОВ</p>
            ...
            <p class="text-center text-bold mb-0">9. УСЛОВИЯ ИЗМЕНЕНИЯ И РАСТОРЖЕНИЯ ДОГОВОРА</p>
            ...
            частью Договора и подписанного предста-вителями Сторон. Одностороннее изменение условий настоящего договора не допускается. <br>
            ...
            <p class="text-center mb-0 text-bold">10. ПРОЧИЕ УСЛОВИЯ</p>
            ...
            <p class="text-center text-bold mb-0">12. ЮРИДИЧЕСКИЕ АДРЕСА СТОРОН</p>
        ...
        <div class="card contract-text">
            ...
            Мы, нижеподписавшиеся, от <b>Заказчика</b> - <span class="text_edit text-bold" contenteditable="false">ООО "Food City Tashkent"</span> в лице лице
