        ...
        <div class="contract2">
            ...
            <div class="card contract-text">
                ...
                <div>
                    ...
                    <p class="text-center text-bold mb-0">2. ОБЯЗАННОСТИ СТОРОН</p>
            ...
            <div class="card contract-text">
                <div>
                    денежных средств на расчётный счёт Подрядчика прямыми банковскими переводами. <br>
            ...
            <div class="card contract-text">
                <div>
                    ...
                    <p class="text-center text-bold mt-3">12. ЮРИДИЧЕСКИЕ АДРЕСА СТОРОН</p>
