    ...
    <section class="app-user-list js_data_all js_data_all_pdf" data-template_number="10">
        ...
        <div class="contract10">
            ...
            <div class="card contract-text">
                ...
                <div>
                    &emsp;&emsp; <b>СП ООО «Ist Telekom»</b>, именуемое в дальнейшем <b>«Оператор»</b>, действующее на основании
            ...
            <div class="card contract-text div-list4 mb-0">
                ...
                <div class="mb-0">
                    ...
                    1.1.&emsp;&emsp; <span class="text_edit">Оператор оказывает Абоненту услуги на непрерывной, круглосуточной основе согласно условиям настоящего договора и требованиям регулирующих
                    органов РУз в сфере телекоммуникаций, действующих на момент оказания услуги.</span> <br/>
                    1.2.&emsp;&emsp; Ответственность за соблюдение параметров рабочих (технических) характеристик и качество услуг, за состояние связи и устранение аварийных
                    ситуаций несут Стороны в своих зонах и границах ответственности. Границей зон ответственности является кроссовое оборудование узла оператора,
                    непосредственно обеспечивающего подачу услуги Абоненту. <br/>
                    1.3.&emsp;&emsp; При оказании Оператором услуги, с использованием любой физической линии связи (абонентская телефонная линия, прямой провод, оптическое волокно)
                    ...
                    1.4.&emsp;&emsp; При оказании Оператором услуги, с использованием любой физической линии связи (абонентская телефонная линия, прямой провод, оптическое волокно)
                    ...
                    Абонент самостоятельно решает вопросы соответствия технических характеристик этих физических линий связи и трактов сети передачи данных
                    <span class="text_edit"> действующим нормативным документам РУз в сфере телекоммуникаций. При изменении требований к техническим характеристикам линий связи и/или
                    параметрам качества оказываемых услуг и не соответствии линии связи, предоставляемой абонентом измененным требованиям, Оператор уведомляет об этом
                    ...
                    2.1.&emsp;&emsp; Телефонные номера и IP-адреса, выданные Абоненту, являются собственностью Оператора. При расторжении Договора Абонент теряет право на дальнейшее использование
                    телефонных номеров и IP –адресов, они переходит во владение Оператора и могут быть выданы другому Абоненту. <br/>
                    2.2.&emsp;&emsp; Если услуга сети передачи данных предполагает ведение учета трафика межсетевых соединения, учет производится Оператором и Абонентом, только на
                    ...
                    2.3.4.&emsp; <span class="text-edit">несоответствие параметров качества и надежности услуг, а также тарификационной информации о трафике между Оператором и Абонентом, возникшие по
                    причине изменения Абонентом конфигурации сети, или установки программного обеспечения</span> и сетевого коммутирующего оборудования,
                    ...
                    3.1.&emsp;&emsp;Мониторинг состояния сети и эксплуатация оборудования и программного обеспечения, регламентные работы производятся Сторонами в соответствии с
                    ...
                    3.3.&emsp;&emsp; Работы по устранению повреждений и/или аварийных ситуаций проводятся в возможно сжатые сроки, но не более чем в течение 24-х часов, с уведомлением
                    ...
                    3.6.&emsp;&emsp;Оплата выезда специалиста Оператора по проблеме со стороны Абонента оплачивается согласно действующим тарифам и оформляется соответствующим Актом. <br/>
                    ...
                    4.3.&emsp;&nbsp; Оператор гарантирует, что информация, полученная с информационных ресурсов, собственником которых является Оператор, не содержит вирусов и вредоносного
                    программного кода. <br/>
                    4.4.&emsp;&nbsp; Оператор не может нести ответственность в случае генерирования трафика в сети Абонента из-за полученных Абонентом вирусов и вредоносного кода
