...
@section('content')
    ...
    <section class="app-user-list js_data_all contract4">
        ...
        <div class="card contract-text">
            ...
            <div>
                ...
                действующего на основании Устава,  с одной стороны, и <b>OOO «PAY-WAY»</b>, именуемый в дальнейшем <b>«Арендатор»</b>, в лице
                ...
                действующий на основании  Устава с другой стороны, вместе именуемые «Стороны», заключили настоящий Договор о нижеследующем: <br>

                <p class="text-center text-bold mt-1">1. ПРЕДМЕТ ДОГОВОРА</p>
                ...
                <p class="text-bold text-center mt-1">2. УСЛОВИЯ И ПОРЯДОК АРЕНДЫ, ОБЯЗАННОСТИ И ПРАВА СТОРОН</p>
        ...
        <div class="card contract-text">
            <div>
                ...
                <p class="text-center text-bold mt-1">3. УСЛОВИЯ И ПОРЯДОК РАСЧЕТОВ</p>
                ...
                <p class="text-center text-bold mt-1">4. ОТВЕТСТВЕННОСТЬ СТОРОН</p>
        ...
        <div class="card contract-text">
            ...
            <p class="text-center text-bold">5. ФОРС-МАЖОР</p>
            ...
            <p class="text-center text-bold mt-1">6. ПОРЯДОК РАЗРЕШЕНИЯ СПОРОВ</p>
            ...
            <p class="text-center text-bold mt-1">7. СРОК ДЕЙСТВИЯ ДОГОВОРА И ПОРЯДОК ЕГО РАСТОРЖЕНИЯ</p>
        ...
        <div class="card contract-text">
            <div>
                ...
                <p class="text-center text-bold mt-1">8. ПРОЧИЕ УСЛОВИЯ</p>
                ...
                <p class="text-center text-bold mt-5">8. ЮРИДИЧЕСКИЕ АДРЕСА И БАНКОВСКИЕ РЕКВИЗИТЫ СТОРОН</p>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 inn">
                        ...
                        <p class="mt-5 mb-5 text-bold text-center">Генеральный директор</p>
                        <p class="mb-5 text-bold text-center">Lee Baek Hee</p>
                        <p class="text-center mt-5">_________________________________</p>
                    ...
                    <div class="col-md-6 inn js_tin_div1">
                        ...
                        <p class="text-center mt-5 text-bold"><span class="text_edit js_director" contenteditable="false">Директор</span></p>
                        <p class="text-center mb-5"><span class="text_edit text-bold" contenteditable="false">Ахмедов Ж.А</span></p>
