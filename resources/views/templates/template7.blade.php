    ...
    <section class="app-user-list js_data_all js_data_all_pdf" data-template_number="7">
        ...
        <div class="contract7">
            ...
            <div class="card contract-text div-list4">
                ...
                <div class="mb-0">
                    <p class="text-center text-bold mb-1 mt-1">Регламент организационно-технического взаимодействия</p>

                    <p class="text-bold mb-1">1.	Общие положения</p>
                    ...
                    1.2.	Ответственность за соблюдение параметров рабочих (технических) характеристик и качество услуг, за состояние связи и устранение аварийных
                    ...
                    <span class="text_edit"> действующим нормативным документам РУз в сфере телекоммуникаций. При изменении требований к техническим характеристикам линий связи
                        и/или параметрам качества оказываемых услуг и не соответствии линии связи, предоставляемой абонентом измененным требованиям, Оператор уведомляет об этом
                        Абонента не позднее одного месяца после даты введения изменений</span> <br/>
                    <p class="text-bold mb-1 mt-1">2.	Техническое описание и порядок предоставления услуг</p>
                    ...
                    2.3.4.	<span class="text-edit">несоответствие параметров качества и надежности услуг, а также тарификационной информации о трафике между Оператором и Абонентом, возникшие по
                    ...
                    <p class="text-bold mb-1 mt-1">3.	Эксплуатация и устранение повреждений</p>
                    3.1.	Мониторинг состояния сети и эксплуатация оборудования и программного обеспечения, регламентные работы производятся Сторонами в соответствии с
                    ...
                    <p class="text-bold mb-1 mt-1">4.	Вопросы информационной безопасности</p>
                    ...
                    4.3.	Оператор гарантирует, что информация, полученная с информационных ресурсов, собственником которых является Оператор, не содержит вирусов и вредоносного
                    программного кода. <br/>
                    4.4.	Оператор не может нести ответственность в случае генерирования трафика в сети Абонента из-за полученных Абонентом вирусов и вредоносного кода
